        ...
        <f-card>
            <template v-if="!dTransactionByHashError">
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col"><div class="break-word" v-show="cTransaction">{{  WEIToAXIS(cTransaction.value) }} AXIS</div></div>
                </div>
                <!--
                            <div class="row no-collapse">
                                <div class="col-4 f-row-label">{{ $t('view_transaction_detail.fee') }}</div>
                                <div class="col"><div class="break-word" v-show="cTransaction">{{  WEIToAXIS(cTransaction.fee) }} AXIS</div></div>
                            </div>
                -->
                <div class="row no-collapse">
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col"><div class="break-word" v-show="cTransaction">{{  cTransactionFee }} AXIS</div></div>
                </div>
                <div class="row no-collapse">
    ...
    export default {
        ...
        computed: {
            ...
            cTransactionFee() {
                ...
                if (transaction) {
                    return WEIToAXIS(this.formatHexToInt(transaction.gasPrice) * this.formatHexToInt(transaction.gasUsed));
                }
